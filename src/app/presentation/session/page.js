    ...
    <div className="flex flex-col h-screen bg-white overflow-hidden">
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <div className="flex-1 flex flex-col overflow-hidden p-4 gap-4 bg-[#f3f7fd]">
          {/* Classroom Wireframe */}
          <div className="flex-1 rounded-2xl border-2 border-dashed border-slate-300 bg-slate-100 relative overflow-hidden min-h-0">
            {/* Wireframe label */}
            ...
            <div className="absolute inset-0 p-8 flex flex-col justify-end gap-3 opacity-30">
              {/* Row 1 */}
